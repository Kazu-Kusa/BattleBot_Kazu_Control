...
class MatchDemo(UpController, UpTech):
    ...
    def react_according_edge_detection(self):
        ...
        judge_dict = {0: self.no_edge_detected, 1: self.front_left, 2: self.front_right,
                      3: self.rear_right, 4: self.rear_left, 5: self.front_double,
                      6: self.rear_double, 7: self.left_double, 8: self.right_double}
        ...
        if io_4 == 0:
            ...
            if self.tag_id == self.friendly_tag:
                ...
                while 1:
                    ...
                    n4 += 1
                    if edge != 0 or n4 >= 16:
                        self.react_according_edge_detection()()
                        break
